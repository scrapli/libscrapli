...
pub const OperationOptions = struct {
    ...
    operation: union(enum) {
        ...
        netconf: union(enum) {
            ...
            create_subscription: operation_netconf.CreateSubscriptionOptions,
            establish_subscription: operation_netconf.EstablishSubscriptionOptions,
            modify_subscription: operation_netconf.ModifySubscriptionOptions,
            delete_subscription: operation_netconf.DeleteSubscriptionOptions,
            resync_subscription: operation_netconf.ResyncSubscriptionOptions,
            kill_subscription: operation_netconf.KillSubscriptionOptions,
